 ...
 *
 * Functions called in document.ready are automatic and parameters need 
 * to be set in the html document.  However, any function can
...
$( document ).ready(function() 
{
	...
	switch(gradeChartType){
		case 'studentOneGrade':
			...
			studentOneGrade(cid, idassignment);
			break;
		case 'studentAllGradesOneClass':
			// Need to get parameters from the html document
			studentAllGradesOneClass(cid);
			break;
		...
		case 'professorOneStudentOneGrade':
			// Need to get parameters from the html document
			professorOneStudentOneGrade(studentid, cid, idassignment);
			break;
		case 'professorOneStudentAllAssignments':
			// Need to get parameters from the html document
			professorOneStudentAllAssignments(studentid, cid);
			break;
		case 'professorOneClassOneAssignment':
			// Need to get parameters from the html document
...
// 
function professorOneClassAllAssignments(cid){
	
	$.ajax({
		async: true,
		type: 'POST',
		url: "grades.php",
		data: {'gradeQuery': 'professorOneClassAllAssignments',
				      'cid': cid},
		datatpye: "json",
		success: function(result){
			//alert(result);
